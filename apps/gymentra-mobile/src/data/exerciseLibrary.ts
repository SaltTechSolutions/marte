...
export const EXERCISES: Exercise[] = [
  ...
  {
    id: 'leg-curl', tr: 'Bacak curl', en: 'Leg curl',
    difficulty: 'BAŞLANGIÇ', equipTr: 'Makine ya da direnç bandı', equipEn: 'Machine or resistance band',
    primary: ['hamBF', 'hamST'],
    secondary: ['gastroLat', 'gastroMed'],
    archetype: 'leg_curl',
    setsHint: '3 × 10-15', restHint: '60-90 sn',
    steps: [
      ['Uyluğu sabit tut; hareketi yalnızca diz yapsın, kalça açısı değişmesin.', 'Keep the thigh still; the movement happens at the knee only, the hip angle does not change.'],
      ['Topuğu kalçaya doğru çek, tepede bir an dur, sonra kontrollü aç.', 'Curl the heel toward the glute, pause briefly, then extend under control.'],
      ['Çizim ayakta yapılanı gösteriyor; yatarak ya da oturarak makinede aynı kas aynı şekilde çalışır.', 'The drawing shows the standing version; lying and seated machines train the same muscle the same way.'],
    ],
    poseReviewed: false,
  },
  {
  ...
  },
  {
    ...
    difficulty: 'BAŞLANGIÇ', equipTr: 'Makine', equipEn: 'Cable machine',
    primary: ['lat', 'teres', 'biceps'],
    secondary: ['trapMid', 'trapLower', 'deltPost', 'brachialis'],
    archetype: 'lat_pulldown',
    setsHint: '3 × 8-12', restHint: '90-120 sn',
    steps: [
      ['Otur, dizleri pede sabitle; barı omuz genişliğinden biraz açık tut, kollar yukarıda açık.', 'Sit with thighs under the pad; grip the bar slightly wider than shoulders, arms extended overhead.'],
      ['Gövdeyi hafif geriye yaslayıp barı göğsün üst kısmına çek; dirsekler aşağı ve gövdeye doğru.', 'Lean back slightly and pull the bar to the upper chest, driving the elbows down and in.'],
      ['Kontrollü bırak, kolları tam açarak bitir. Barfiksle aynı işi yapar; farkı ağırlığın seçilebilmesi.', 'Return under control to full extension. Same pattern as a pull-up, with selectable load.'],
    ],
    poseReviewed: false,
  },
  {
